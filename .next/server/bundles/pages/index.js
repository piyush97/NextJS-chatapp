...
var Layout_Layout = function Layout(props) {
  ...
  }), external__react__default.a.createElement("title", null, props.pageTitle || 'Sentimental Chat')), props.children);
};
...
function (_Component) {
  ...
  Chat__createClass(Chat, [{
    ...
    value: function componentDidMount() {
      ...
      this.pusher = new external__pusher_js__default.a("9e74f3af0b3368fe4216", {
        cluster: "ap2",
        encrypted: true
      });
...
function (_Component) {
  ...
  pages__createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      }, "Ji aaya nu!"), " ", user) : "Ahoo!  \n                            Naa Ki hai Tuhada?"), !user && external__react__default.a.createElement("input", {
        type: "text",
